...
js_parts = [read(os.path.join(SRC, n)) for n in ['data.js', 'minigames.js', 'render.js', 'game.js', 'ai.js', 'sabotage.js', 'specials.js', 'meeting.js', 'music.js', 'settings.js', 'extras.js', 'campaign.js', 'net.js']]
js = '\n'.join(js_parts)
