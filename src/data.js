...
const DECOR = [
  ...
  // --- extras (rodada 1 de estética) ---
  { type:'sink',     x:2130, y:740 },
  { type:'pantry',   x:2340, y:700 },
  { type:'pots',     x:2040, y:620 },
  { type:'chair',    x:1560, y:520 }, { type:'chair', x:1620, y:520 }, { type:'chair', x:1680, y:520 }, { type:'chair', x:1740, y:520 },
  { type:'chair',    x:1560, y:660 }, { type:'chair', x:1620, y:660 }, { type:'chair', x:1680, y:660 }, { type:'chair', x:1740, y:660 },
  { type:'fireplace',x:1500, y:470 },
  { type:'wardrobe', x:1140, y:80 },
  { type:'vanity',   x:1250, y:250 },
  { type:'statue',   x:1530, y:230 }, { type:'statue', x:1990, y:230 },
  { type:'gbench',   x:1700, y:240 }, { type:'gbench', x:1850, y:240 },
  { type:'board',    x:1860, y:1190 },
  { type:'spiral',   x:130,  y:250 },
  { type:'starmap',  x:300,  y:220 },
  { type:'owl',      x:300,  y:95 },
  { type:'glass',    x:640,  y:985, c:'#e74c3c' }, { type:'glass', x:940, y:985, c:'#3498db' },
  { type:'chains',   x:140,  y:1100 },
  { type:'rat',      x:220,  y:1060 }, { type:'rat', x:400, y:1180 },
  { type:'fountain', x:1400, y:1200 },
  { type:'pumpkin',  x:1180, y:1060 }, { type:'pumpkin', x:1215, y:1075 },
  { type:'mirror',   x:650,  y:250 },
  { type:'mannequin',x:540,  y:250 },
  { type:'armor',    x:720,  y:470 }, { type:'armor', x:1310, y:470 },
  { type:'lamp',     x:740,  y:790 }, { type:'lamp', x:1300, y:790 },
  { type:'pew2',     x:680,  y:1060 }, { type:'pew2', x:860, y:1060 },
  { type:'crate',    x:800,  y:250 },
];
